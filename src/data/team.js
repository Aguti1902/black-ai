export const team = [
  {
    name: 'Jose Mora',
    email: 'jose.mora@blackai.com',
    role: { en: 'Chief Executive Officer (CEO)', es: 'Consejero Delegado (CEO)' },
    bio: {
  ...
  },
  {
    ...
    email: 'charlie.faulkner@blackai.com',
    role: { en: 'Chief Business Development Officer (CBDO)', es: 'Director de Desarrollo de Negocio (CBDO)' },
    bio: {
  ...
  },
  {
    ...
    email: 'simon.wajcenberg@blackai.com',
    role: { en: 'Chief Financial Officer (CFO)', es: 'Director Financiero (CFO)' },
    bio: {
  ...
  {
    name: 'Carmen Mora',
    email: 'carmen.mora@blackai.com',
    role: { en: 'Chief Operating Officer (COO)', es: 'Directora de Operaciones (COO)' },
    bio: {
  ...
  {
    name: 'Jesus Mora',
    email: 'jesus.mora@blackai.com',
    role: { en: 'Chief Technology Officer (CTO)', es: 'Director de Tecnología (CTO)' },
    bio: {
  ...
  {
    name: 'Jose Monrobe',
    email: 'jose.monrobe@blackai.com',
    role: { en: 'Head of Communications', es: 'Director de Comunicación' },
    bio: {
  ...
  {
    name: 'Ana Arias',
    email: 'ana.arias@blackai.com',
    role: { en: 'Managing Director, Latin America', es: 'Directora General, América Latina' },
    bio: {
  ...
  {
    name: 'Miguel Collado',
    email: 'miguel.collado@blackai.com',
    role: { en: 'Director of Land Intelligence, Latin America', es: 'Director de Inteligencia Territorial, América Latina' },
    bio: {
